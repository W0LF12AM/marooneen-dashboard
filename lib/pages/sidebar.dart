    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          const double minW = 1280.0;
          const double minH = 800.0;
          final double targetW = constraints.maxWidth < minW ? minW : constraints.maxWidth;
          final double targetH = constraints.maxHeight < minH ? minH : constraints.maxHeight;
